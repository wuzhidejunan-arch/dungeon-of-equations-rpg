    ...
    stages: {
      101: {
        ...
        questions: [
          ...
          { expression: '4 × 2', options: [6, 7, 8, 9], answer: 8 },
          { expression: '3 × 5', options: [12, 15, 18, 20], answer: 15 },
          { expression: '6 × 2', options: [10, 11, 12, 14], answer: 12 },
          { expression: '5 × 4', options: [18, 19, 20, 21], answer: 20 },
          { expression: '7 × 3', options: [18, 20, 21, 24], answer: 21 },
          { expression: '8 × 2', options: [14, 15, 16, 18], answer: 16 },
          { expression: '9 × 1', options: [7, 8, 9, 10], answer: 9 },
          { expression: '10 × 2', options: [18, 19, 20, 22], answer: 20 },
          { expression: '4 × 6', options: [20, 22, 24, 26], answer: 24 },
          { expression: '3 × 7', options: [18, 20, 21, 24], answer: 21 },
          { expression: '6 × 3', options: [15, 16, 18, 21], answer: 18 },
          { expression: '7 × 4', options: [24, 26, 28, 30], answer: 28 },
          { expression: '8 × 3', options: [21, 22, 24, 27], answer: 24 },
          { expression: '9 × 2', options: [16, 18, 20, 22], answer: 18 },
          { expression: '5 × 5', options: [20, 25, 30, 35], answer: 25 },
          { expression: '11 × 2', options: [20, 21, 22, 24], answer: 22 },
          { expression: '12 × 3', options: [30, 33, 36, 39], answer: 36 },
          { expression: '4 × 7', options: [24, 26, 28, 32], answer: 28 },
          { expression: '6 × 5', options: [28, 29, 30, 31], answer: 30 },
        ],
      },
      102: {
        id: 102,
        name: 'Stage 2 - Division',
...
Read the battle message after each action.`,
    ...
    guidedBattle: {
      ...
      helperTexts: {
        ...
        mainOtherSelected: 'Use Fight only in this lesson. Bag and Run are locked.',
        skillCorrect: 'Good. {skill} is the right skill now. Press Enter.',
        skillWrong: 'Use {skill} for this step.',
        builder: 'Make the answer for {skill}. Use Armor Break first. Heavy Strike needs an even answer.',
        dialog: 'Read each battle message. It tells you what happened.',
        fallback: 'Read the rule. Choose the skill. Make the answer.',
