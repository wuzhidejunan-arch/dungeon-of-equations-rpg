...
export const enemyData = {
  trainingDummy: createEnemy({
    ...
    imageDisplay: { width: 95, height: 110, offsetX: 0, offsetY: -8 },
    hp: 18,
    attack: 2,
    goldReward: 0,
    expReward: 0,
  ...
  slime: createEnemy({
    ...
    imageDisplay: { width: 100, height: 100, offsetX: 0, offsetY: 8 },
    hp: 30,
    attack: 3,
    goldReward: 10,
    expReward: 8,
  ...
  bat: createEnemy({
    ...
    imageDisplay: { width: 120, height: 90, offsetX: 0, offsetY: -18 },
    hp: 24,
    attack: 3,
    goldReward: 12,
    expReward: 10,
  ...
  boss1: createEnemy({
    ...
    imageDisplay: { width: 125, height: 125, offsetX: 0, offsetY: 0 },
    hp: 45,
    attack: 4,
    goldReward: 20,
    expReward: 14,
  ...
  boss2: createEnemy({
    ...
    imageDisplay: { width: 135, height: 115, offsetX: 0, offsetY: -5 },
    hp: 55,
    attack: 4,
    goldReward: 25,
    expReward: 18,
  ...
  boss3: createEnemy({
    ...
    imageDisplay: { width: 135, height: 135, offsetX: 0, offsetY: 0 },
    hp: 70,
    attack: 5,
    goldReward: 30,
    expReward: 22,
  ...
  finalBoss: createEnemy({
    ...
    imageDisplay: { width: 170, height: 170, offsetX: 0, offsetY: -28 },
    hp: 100,
    attack: 6,
    goldReward: 60,
    expReward: 30,
  ...
  intermediate_armorDummy: createEnemy({
    ...
    imageDisplay: { width: 100, height: 112, offsetX: 0, offsetY: -14 },
    hp: 20,
    attack: 4,
    goldReward: 24,
    expReward: 22,
  ...
  intermediate_evenStoneGatekeeper: createEnemy({
    ...
    imageDisplay: { width: 122, height: 122, offsetX: 0, offsetY: -6 },
    hp: 52,
    attack: 5,
    goldReward: 20,
    expReward: 18,
  ...
  intermediate_oddFangGatekeeper: createEnemy({
    ...
    imageDisplay: { width: 124, height: 112, offsetX: 0, offsetY: -14 },
    hp: 40,
    attack: 10,
    goldReward: 22,
    expReward: 20,
  ...
  intermediate_ironCoreGatekeeper: createEnemy({
    ...
    imageDisplay: { width: 126, height: 126, offsetX: 0, offsetY: -20 },
    hp: 58,
    attack: 6,
    goldReward: 24,
    expReward: 22,
  ...
  intermediate_armorCoreLord: createEnemy({
    ...
    imageDisplay: { width: 142, height: 142, offsetX: 0, offsetY: -28 },
    hp: 72,
    attack: 8,
    goldReward: 30,
    expReward: 28,
  ...
  challenge_training_scout: createEnemy({
    ...
    imageDisplay: { width: 108, height: 120, offsetX: 0, offsetY: -18 },
    hp: 20,
    attack: 2,
    goldReward: 0,
    expReward: 0,
  ...
  challenge_chainCrawler: createEnemy({
    ...
    imageDisplay: { width: 112, height: 112, offsetX: 0, offsetY: -8 },
    hp: 34,
    attack: 4,
    goldReward: 18,
    expReward: 16,
  ...
  challenge_splitwingImp: createEnemy({
    ...
    imageDisplay: { width: 132, height: 108, offsetX: 0, offsetY: -40 },
    hp: 28,
    attack: 5,
    goldReward: 20,
    expReward: 18,
  ...
  challenge_balancedSentinel: createEnemy({
    ...
    imageDisplay: { width: 150, height: 150, offsetX: 0, offsetY: -30 },
    hp: 46,
    attack: 5,
    goldReward: 24,
    expReward: 20,
  ...
  challenge_crookedSentinel: createEnemy({
    ...
    imageDisplay: { width: 160, height: 160, offsetX: 0, offsetY: -34 },
    hp: 52,
    attack: 6,
    goldReward: 28,
    expReward: 24,
  ...
  challenge_chainOracleLord: createEnemy({
    ...
    imageDisplay: { width: 195, height: 195, offsetX: 0, offsetY: -20, shadowOffsetY: 44 },
    hp: 78,
    attack: 8,
    goldReward: 48,
    expReward: 34,
